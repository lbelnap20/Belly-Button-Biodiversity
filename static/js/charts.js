...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var freqResultArray = freq.filter(sampleObj => sampleObj.id
      == sample);
    var freqResult = freqResultArray [0];
    var wfreq = parseFloat(freqResult.wfreq);
